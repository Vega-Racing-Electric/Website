      ...
      <div className="about">
        <div className="about-container">
          <div className='img-content left'>
            <img className='img-inside-wrapper' src='images/Logo-Big.jpg' alt="VRE Logo" />
          </div>
        ...
        <div className="about-container">
          ...
          <div className='img-content right'>
            <img className='img-inside-wrapper' id='research' src='images/Research3.png' alt="Research" />
          </div>
        </div>
      </div>
    </>
