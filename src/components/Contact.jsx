            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-16">
                    ...
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="p-6 border border-primary/20 bg-primary/5 rounded-sm flex items-center justify-between group cursor-pointer hover:bg-primary/10 transition-colors">
