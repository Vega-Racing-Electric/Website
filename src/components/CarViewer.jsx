            ...
            <ErrorBoundary>
                <Canvas shadows dpr={[1, 2]}>
                    <Suspense fallback={null}>
                        ...
                        <directionalLight position={[5, 15, 10]} intensity={0} castShadow />
                        <directionalLight position={[-5, 10, -5]} intensity={0} />
                        <spotLight position={[10, 20, 10]} angle={0.3} penumbra={1} intensity={0} castShadow />
                        <pointLight position={[-8, 5, -8]} color="#E63946" intensity={0} />
                        <pointLight position={[8, 5, 8]} color="#ffffff" intensity={0} />
