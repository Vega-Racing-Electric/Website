...
function Navbar() {
  ...
  return (
    <>
      <nav className='navbar' style={scrolled ? { background: 'rgba(10,10,10,.92)' } : {}}>
        <div className='navbar-container'>
          <Link to='/' className='navbar-logo' onClick={closeMobileMenu}>
            <img className="navbar-logo-img" src={logo} alt="Vega Racing Electric" />
          </Link>

          {click
            ? <FaTimes onClick={handleClick} className='menu-icon' />
